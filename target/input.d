...
$(P
Although the code is cleaner and safer without the $(C &) character, I will continue to use $(C readf) with pointers partly to prepare you to the concepts of $(LINK2 /ders/d.en/value_vs_reference.html, references) and $(LINK2 /ders/d.en/function_parameters.html, reference function parameters).
)
