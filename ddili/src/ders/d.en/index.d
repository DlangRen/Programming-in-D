...
<img style="border-width:0; float:left; margin:0 2em 1em 1em;" src="$(ROOT_DIR)/ders/d.en/cover_thumb.png" height="180"/>
...
$(P $(LINK2 /ders/d.en/ix.html, Book Index))
...
$(LI $(LINK2 /ders/d.en/logical_expressions.html, Logical Expressions) $(INDEX_KEYWORDS bool true false ! == != < <= > >= || &&))
...
$(LI $(LINK2 /ders/d.en/floating_point.html, Floating Point Types) $(INDEX_KEYWORDS .nan .infinity isNaN <> !<>= (and more)))
...
$(LI $(LINK2 /ders/d.en/slices.html, Slices and Other Array Features) $(INDEX_KEYWORDS .. $ .dup capacity))
...
$(LI $(LINK2 /ders/d.en/struct.html, Structs) $(INDEX_KEYWORDS struct . {} static, static this, static ~this))
$(LI $(LINK2 /ders/d.en/parameter_flexibility.html, Variable Number of Parameters) $(INDEX_KEYWORDS T[]... __MODULE__ __FILE__ __LINE__ __FUNCTION__ __PRETTY_FUNCTION__))
