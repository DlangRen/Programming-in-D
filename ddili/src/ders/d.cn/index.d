...
$(LI $(LINK2 /ders/d.cn/preface.html, Preface))
...
$(LI $(LINK2 /ders/d.cn/compiler.html, Compilation))
...
$(LI $(LINK2 /ders/d.cn/input.html, Reading from the Standard Input))
$(LI $(LINK2 /ders/d.cn/logical_expressions.html, Logical Expressions) $(INDEX_KEYWORDS bool true false ! == != < <= > >= || &&))
$(LI $(LINK2 /ders/d.cn/if.html, if Statement) $(INDEX_KEYWORDS if else))
...
$(LI $(LINK2 /ders/d.cn/files.html, Files) $(INDEX_KEYWORDS File))
$(LI $(LINK2 /ders/d.cn/auto_and_typeof.html, auto and typeof) $(INDEX_KEYWORDS auto typeof))
$(LI $(LINK2 /ders/d.cn/name_space.html, Name Scope))
...
$(LI $(LINK2 /ders/d.cn/aa.html, Associative Arrays) $(INDEX_KEYWORDS .keys .values .byKey .byValue .byKeyValue .get .remove in))
...
$(LI $(LINK2 /ders/d.cn/exceptions.html, Exceptions) $(INDEX_KEYWORDS throw try catch finally))
...
$(LI $(LINK2 /ders/d.cn/class.html, Classes) $(INDEX_KEYWORDS class new))
...
$(LI $(LINK2 /ders/d.cn/tuples.html, Tuples) $(INDEX_KEYWORDS tuple Tuple AliasSeq .tupleof foreach))
...
$(LI $(LINK2 /ders/d.cn/parallelism.html, Parallelism) $(INDEX_KEYWORDS parallel task asyncBuf map amap reduce))
