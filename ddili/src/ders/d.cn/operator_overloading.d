...
$(P
In most cases it is not necessary to define $(C opBinaryRight), except for the $(C in) operator: It usually makes more sense to define $(C opBinaryRight) for $(C in).
)
